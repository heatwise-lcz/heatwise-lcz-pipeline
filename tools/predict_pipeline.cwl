...
requirements:
  DockerRequirement:
    dockerImageId: ghcr.io/heatwise-lcz/heatwise-lcz-classification-pipeline:0.1.0
    dockerPull: ghcr.io/heatwise-lcz/heatwise-lcz-classification-pipeline:0.1.0
